...
class BudgetLine(models.Model):
    ...
    default_hours = fields.Float(
        ...
        "It can be adjusted per template or simulation as needed. Final line "
        "hours use the complexity factor on this base, or a Python hours "
        "formula when defined below.",
    )
